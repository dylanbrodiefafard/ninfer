...
def add_problem_arguments(parser: argparse.ArgumentParser) -> None:
    ...
    parser.add_argument(
        "--qtype", default=None,
        help="registered q4|q5|q6|w8|nvfp4|bf16|fp8, or exact ggml_q8_0|ggml_q4_k|ggml_q5_k|ggml_q6_k|ggml_iq1_s|ggml_iq2_xxs|ggml_iq4_nl",
    )
...
def analyze(
    ...
    *,
    ...
    if bound == "profile-required":
        ...
        next_step = "Stay in the current SM120 kernel family. Autotune tile/TMA/pipeline; do not invent a new MMA ISA."
