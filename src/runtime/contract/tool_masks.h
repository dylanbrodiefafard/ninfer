...
public:
    ...
    void bind(std::span<const text::qwen::OutputSession* const> outputs,
...
private:
    static void CUDART_CB match(void* opaque) noexcept;
    void fill();
    ...
    std::vector<const text::qwen::OutputSession*> outputs_;
