...
Qwen3.8-27B DFlash2 is chain-only: `W=k+1`, maximum k=5, live adaptive set `{3,4,5}`. The chain
remains the speed recommendation: k=4/W=5 is fastest on AIME. Tree k=7 W=12 was slightly slower
