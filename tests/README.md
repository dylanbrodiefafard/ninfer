...
- `text/qwen/test_tool_grammar.cpp` and `test_frontend.cpp` — declared-schema masks,
...
- `text/qwen/test_generation_recovery.cpp` — contextual duplicate detection, truthful
