...
`qwen3.8-27b/nvfp4`, and `qwen3.6-35b-a3b/groupwise-int`. The current implementation is compiled for `sm_120a` and tuned
...
Engine route; the 35B-A3B target additionally supports text-only DFlash v1, and
`qwen3.8-27b/nvfp4` additionally supports text-only DFlash2 when the artifact contains `dflash/`
objects.
